...
<body>
	<div class="main">
		...
		<div class="personMsg">
			<c:choose>
				<c:when test="${not empty noExamMsg}">
					<font color="red">${noExamMsg}</font>
				</c:when>
				<c:otherwise>
					<table>
						<tr>
		...
		<div class="table3">
			<table id="datable" border="1" class="tab_content">
				<tr>
					...
					<td>责任医生</td>
					<td colspan="2" id="choose_doctor" style="cursor: pointer;"><input type="hidden" name="DoctorID" value="${sessionScope.doctorInfo.id}"><span id="DoctorName">${sessionScope.doctorInfo.docName}</span></td>
				</tr>
				<tr class="bgf1">
					<td class="bold">内容</td>
