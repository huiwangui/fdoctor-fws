...
<script type="text/javascript"
	src="/FWS/statics/layui/layui.js"></script>
<script type="text/javascript" src="/FWS/statics/js/jquery-2.1.4.min.js"></script>
<link rel="stylesheet" type="text/css" href="/FWS/statics/webuploader-0.1.5/webuploader.css">
    <link rel="stylesheet" type="text/css" href="/FWS/statics/image-upload/style.css" />
<script type="text/javascript" src="/FWS/statics/webuploader-0.1.5/webuploader.js"></script>
...
<body style="background-color: gainsboro;">
   <div id="wrapper">
    ...
    <div>
       <label class="layui-form-label">报告描述</label>
    ...
    <div>
       ...
       <label class="layui-form-label">拍片日期</label>
	      <div class="layui-input-inline">
<!-- 	        <input type="text" name="date" id="date1" lay-verify="date" placeholder="" autocomplete="off" class="layui-input" onclick="layui.laydate({elem: this})">
 ...
 -->	  
             <input type="text" class="Wdate" id="date1" onfocus="WdatePicker({skin:'whyGreen',dateFmt: 'yyyy-MM-dd', maxDate:'%y-%M-%d', readOnly:true})"  style="background-color:#e4e4e4;; height:30px; width:100%"></input>
          </div>
	  ...
	  <div class="layui-inline" >
		 <div class="layui-form-item"  style="margin-left: 400px">  
			   <div class="layui-inline" style="width:30%;margin-left: 0px;float:left" >
					 <div class="layui-input-inline">
			    	   <button class="layui-btn layui-btn-radius" style="width: 100%" id="saveButton" type="button">保存</button>
			    	 </div>
				</div>
		 </div>
	  </div>  
...
layui.use('layer', function(){
 ...
 $('#saveButton').on('click',function(){
	 ...
	 if($('#date1').val()==''){
	  ...
	  $.ajax({
		url:'/FWS/resident/uploadUserReport',
		type : 'POST',
		data:{
			personId:'${personId}',
			img:strimg,
			reportDescription:$('#contactus').val(),
			imgTime:$('#date1').val()
...
(function( $ ){
    ...
    $(function() {
        ...
        uploader = WebUploader.create({
            ...
            chunked: false,
            chunkSize: 512 * 1024,
            server: '/FWS/resident/uploadUserSignByDocFWS',
            // runtimeOrder: 'flash',
