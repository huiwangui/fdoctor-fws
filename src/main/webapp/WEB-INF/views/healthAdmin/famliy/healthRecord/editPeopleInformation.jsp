		...
		<div class="main">
			...
			<div class="content_div">
				<div class="personNumber">
					<table>
						<tr>
							<td class="tr">个人编号：${data.PersonCode }</td>
				...
				<table class="health_table1">
					...
					<tr>
						...
						<td>
							...
							<a href="javascript:void(0)" class="sibtn_small" onclick="validCard()">验证身份证</a>
							<!-- <label>
					...
					<tr>
						...
						<td> 
							<input type="text" name="CurrentAddress" id="CurrentAddress" value="${add}" class="borderb"/>
							<!-- <input type="button" name="" id="masterAdd" value="当前户主地址" class="sibtn_small"/> 
							<input type="button" name="" id="currentAdd" value="使用当前组" class=""/>  -->
							<a href="javascript:void(0)" class="sibtn_small" id="masterAdd" onclick="addAddress()">当前户主地址</a>
							<a href="javascript:void(0)" class="sibtn_small" id="masterAdd" onclick="CurrentAddress()">使用当前组</a>
						</td>
					</tr>
					<tr>
						<td class="tr">户籍地址：</td>
						<td>
							...
							<a href="javascript:void(0)" class="sibtn_small" id="fAdd" onclick="ResidenceAddress()">使用现住址</a>
							<span>
								贫困人口： 
				...
				<%-- 	<tr>
						<td class="tr">本人电话：</td>
						<td>
							<input type="text" name="PersonTel"  value="${data.phoneNumber }"  class="borderb" disabled="disabled"/>
							<label>
					...
					<tr>
						...
						<td>
							<select id="HouseholderRelationship" name="">
								<c:if test="${data.HouseholderRelationship ==1}">
							...
							<label >
								<input type="radio" name="resname" id="agriculture1" value="1" /> 农业
							</label>
							<label >
								<input type="radio" name="resname" id="agriculture2" value="2" />非 农业
							</label>
							<label >
								<input type="checkbox" name="IsFlowing" id="IsFlowing"  value="1" /> 流动人口
							</label>
						</td>
					</tr>
					...
					<tr>
						<td class="tr">建档日期：</td>
						<td>
							<input type="date"  name="BuildDate" id="BuildDate"  value="${data.BuildDate }" class="borderb"/>
						</td>
					</tr>
				</c:if>
				</table>
			...
			<div class="content_div" hidden="">
				...
				<table border="1">
					<tr>
						...
						<td><span class="redcolor">*</span>出生日期</td>
						<td>
							<input  name="BirthDay" id="BirthDay" value="${data.BirthDay }" onClick="WdatePicker()" />
						</td>
					</tr>
					<tr>
						<td>身份证号</td>
					...
					<tr>
						...
						<td>民族</td>
						<td>
					          <input type="hidden" id="NationCodeInput" value="${data.NationCode}">
							  <select name="NationCode" id="NationCode" value="${data.NationCode}">
					...
					<tr>
						...
						<td colspan="5" id="JobCodeTd">						 
							...
							<!-- 这里还有待处理 -->
						<!-- 	<select id="JobOther" name="JobOther"> 
								<option value="1">学龄前</option>
								<option value="2">学生</option>
								<option value="3">农民</option>
							</select> -->
							<span class="fr">  <input type="text" name="JobCode" id="JobCode" value="${data.JobCode}" class="w20"/></span>
						</td>
					</tr>
					<tr>
						<td>婚姻状况</td>
					...
					<tr>
						...
						<td colspan="5" id="PaymentWayTd">
							...
							<span class="fr" id="payFr">	
							  <!-- 	<span style="width: 16px;height: 16px;display: inline-block;text-align: center;line-height: 16px;border: 1px solid #333;">1</span>				 
					...
					<tr>
						...
						<td colspan="4" class="diseases_td" id="diseasesTd">
							<span  id="noDiseases" class="Noption chosed">1 无</span>
					...
					<tr>
						<td>遗传病史</td>
						<td class="ycb" >
							<span class="N1" id="ycbswu">1 无</span>
							<span class="N2" id="ycbs2">2 有</span>
						</td>
					...
					<tr>
						...
						<td colspan="5" id="DisabilityingTd" >						 
							<a   id="1" value="1" class="Noption">1 无残疾   </a>      
							<a   id="2" value="2" class="optionMore">2 视力残疾   </a>
							<a   id="3" value="4" class="optionMore">3 听力残疾   </a>
							<a   id="4" value="8" class="optionMore">4 言语残疾   </a>
							<a   id="5" value="16" class="optionMore">5 肢体残疾   </a>
							<a   id="6" value="32" class="optionMore">6 智力残疾   </a>
							<a   id="7" value="64" class="optionMore">7 精神残疾   </a>
							<a   id="8" value="128" class="optionMore">8 其它残疾   </a>
...
<!------------------------------------档案信息卡---------------------------->
			<div class="content_div1" hidden="">
				...
				<div class="msg_card_table">
					<table border="1">
						...
						<tr>
							<td>血型</td>
							<td colspan="2" id="BloodTypeingTd">
								<label >
									<input type="radio" name="BloodTypeing" id="1"  <c:if test="${data.BloodType==1}">checked="checked"</c:if>  />A
								</label>
								<label >
									<input type="radio" name="BloodTypeing" id="2"   <c:if test="${data.BloodType==2}">checked="checked"</c:if>  />B
								</label>
								<label >
									<input type="radio" name="BloodTypeing" id="3"  <c:if test="${data.BloodType==3}">checked="checked"</c:if>   />O
								</label>
								<label >
									<input type="radio" name="BloodTypeing" id="4"  <c:if test="${data.BloodType==4}">checked="checked"</c:if> />AB
								</label>
								<label >
									<input type="radio" name="BloodTypeing" id="5"   <c:if test="${data.BloodType==5}">checked="checked"</c:if>/>不详
								</label>
							</td>
							<td>RH阴性</td> 
							<td colspan="2" id="RhBloodingTd">
								<label >
									<input type="radio" name="RhBlooding" id="1"   <c:if test="${data.RhBlood==1}">checked="checked"</c:if> />否
								</label>
								<label >
									<input type="radio" name="RhBlooding" id="2"    <c:if test="${data.RhBlood==2}">checked="checked"</c:if>  />是
								</label>
								<label >
									<input type="radio" name="RhBlooding" id="3"     <c:if test="${data.RhBlood==3}">checked="checked"</c:if>/>不详
								</label>							
							</td>
						</tr>
						<tr>
	...
	//与户主关系回显
	$("#HouseholderRelationship option[value='${data.HouseholderRelationship}']").attr("selected",true);
	
	//是否农业人口 回显
	$("input[name='resname'][value='${data.ResType}']").attr("checked",true);  //根据Value值设置Radio为选中状态
	//流动人口回显
	$("input[name='IsFlowing'][value='${data.IsFlowing}']").attr("checked",true);
	//贫困人口回显 IsPoor
	 $("#IsPoor option[value='${data.IsPoor}']").attr("selected",true)
	//性别处理
	if($('#GenderCode').val()==0){
    ...
    //职业其他回显
  //  $("#JobOther option[value='${data.OtherJobCode}']").attr("selected",true); //
	...
	$("#JobCodeTd").find("a").each(function(i){
     ...
     //民族回显
    var nationcode=$('#NationCodeInput').val()
    $("#NationCode option[value='"+nationcode+"']").attr("selected",true)
  ...
  function getBlueColorWithObj(sss,str,obj){
	...
	$('#noDiseases').addClass('chosed')
	if(CdList!=null&&CdList.length>0){
		$('#noDiseases').removeClass('chosed')
		for(var i=0;i<CdList.length;i++){
			...
			if("52A0328740914BCE86ED10A4D2521816"==cid){
				  //高血压
				  $('#diseasesTd span').eq(1).addClass('bluecolor')
				  $("#highBloodPressure").val(time)
				  $('.box1').eq(0).toggle();
			}else if("7AA0AFF1DDA040F18510513DE3753547"==cid){
				//糖尿病
				 $('#diseasesTd span').eq(2).addClass('bluecolor')
				 $("#diabetes").val(time)
				 $('.box1').eq(1).toggle();
			}else if("708DE71884C645D0AEF802E06C6B4B12"==cid){
				//冠心病
				 $('#diseasesTd span').eq(3).addClass('bluecolor')
				 $("#coronaryHeartdDisease").val(time)
				 $('.box1').eq(2).toggle();
			}else if("C2B2CB0803EC46A684A00AE350A34251"==cid){
				//慢性阻塞性肺疾病
				 $('#diseasesTd span').eq(4).addClass('bluecolor')
				 $("#chronicObstructivePulmonaryDisease").val(time)
				 $('.box1').eq(3).toggle();
			}else if("E63F8CF300D44FECBD6FF96B9FCAF39C"==cid){
				//恶性肿瘤
				 $('#diseasesTd span').eq(5).addClass('bluecolor')
				 $("#cancer").val(time)
				 $('.box1').eq(4).toggle();
			}else if("37A51584E2EF43D09CEF1CE8D69BDEB8"==cid){
				//脑卒中
				 $('#diseasesTd span').eq(6).addClass('bluecolor')
				 $("#stroke").val(time)
				 $('.box1').eq(5).toggle();
			}else if("FC6FF7E27F064D9C98DCD5C83E70F119"==cid){
				//重性精神疾病
				 $('#diseasesTd span').eq(7).addClass('bluecolor')
				 $("#severeMentalIllness").val(time)
				 $('.box1').eq(6).toggle();
			}else if("52A0328740914BCE86ED10A4D2521814"==cid){
				//结核病
				 $('#diseasesTd span').eq(8).addClass('bluecolor')
				 $("#tuberculosis").val(time)
				 $('.box1').eq(7).toggle();
			}else if("AB9E834EDC1B4FE68CD41C94767AFD9A"==cid){
				//肝炎
				 $('#diseasesTd span').eq(9).addClass('bluecolor')
				 $("#hepatitis").val(time)
				 $('.box1').eq(8).toggle();
			}else if("DE414310BBCA47299208FD524D3B617A"==cid){
				//其他法定传染病
				 $('#diseasesTd span').eq(10).addClass('bluecolor')
				 $("#notifiableDisease").val(time)
				 $('.box1').eq(9).toggle();
			}else if("930FAEAF1DA34246A2CBDDA86EE480CD"==cid){
				//职业病
				 $('#diseasesTd span').eq(11).addClass('bluecolor')
				 $("#industrialDisease").val(time)
				 $('.box1').eq(10).toggle();
			}else if("9D9B81363B3C4A699ECB77AFF805D411"==cid){
				//其他
				$('#diseasesTd span').eq(12).addClass('bluecolor')
				$("#DiseaseOtherDate").val(time)
				$("#DiseaseOther").val(CdList[i].remark)
				$('.box1').eq(11).toggle();
			...
			for(var i=0;i<flist.length;i++){
				...
				if(flist[i].RecordType==3){
					...
					if($("#transfusion input[name='name1']").length==0){
						var sx= '<div class="add_illness" >名称： <input type="text" name="name1"  value='+flist[i].Name+' class="borderb"/> 时间： <input type="text" name="time"  value='+ time+' class="borderb" onClick="WdatePicker()"/>'+'<a href="javascript:void(0)" class="add">+</a></div>';
						$("#transfusion").html(sx);
					}else if($("#transfusion input[name='name1']").length>0){
						var sx= '<div class="add_illness" >名称： <input type="text" name="name1"  value='+flist[i].Name+' class="borderb"/> 时间： <input type="text" name="time"  value='+ time+' class="borderb" onClick="WdatePicker()"/>'+'<a href="javascript:void(0)" class="delete" onclick="delete_this(this)">X</a></div>';
					...
					if($("#trauma input[name='name1']").length==0){
						var ws= '<div class="add_illness" >名称： <input type="text" name="name1"  value='+flist[i].Name+' class="borderb"/> 时间： <input type="text" name="time"  value='+ time+' class="borderb" onClick="WdatePicker()"/>'+'<a href="javascript:void(0)" class="add">+</a></div>';
						$("#trauma").html(ws);
					}
					else if($("#trauma input[name='name1']").length>0){
						var ws= '<div class="add_illness" >名称： <input type="text" name="name1"  value='+flist[i].Name+' class="borderb"/> 时间： <input type="text" name="time"  value='+ time+' class="borderb" onClick="WdatePicker()"/>'+'<a href="javascript:void(0)" class="delete" onclick="delete_this(this)">X</a></div>';
						$("#trauma").append(ws);
					}
					...
					$("#operation").html("");
					var traumaoption= '<div class="add_illness" >名称： <input type="text" name="name1"  value='+flist[i].Name+' class="borderb"/> 时间： <input type="text" name="time"  value='+ time+' class="borderb" onClick="WdatePicker()"/>'+'<a href="javascript:void(0)" class="add">+</a></div>';
					$("#operation").html(traumaoption);
					}else
				    if($("#operation input[name='name1']").length>0){
						var ss= '<div class="add_illness" >名称： <input type="text" name="name1"  value='+flist[i].Name+' class="borderb"/> 时间： <input type="text" name="time"  value='+ time+' class="borderb" onClick="WdatePicker()"/>'+'<a href="javascript:void(0)" class="delete" onclick="delete_this(this)">X</a></div>';
						$("#operation").append(ss);
					} 
				}else if(flist[i].RecordType==4){
				
					 //遗传病史
				    $('#ycbs2').addClass('bluecolor')
				    $('#ycbswu').removeClass('bluecolor')
					if($("#inheritance input[name=name1]").length==0){
					var inheritanceoption='<div class="box2" >名称： <input type="text" name="name1"   value='+flist[i].Name+' class="borderb"/> 时间： <input type="text" name="time"   value='+ time+' class="borderb" onClick="WdatePicker()"/>'+'<a href="javascript:void(0)" class="add_box2">+</a></div>';
					$("#inheritance").html(inheritanceoption);
					}
					else if($("#inheritance input[name=name1]").length>0){
						var inheritanceoption='<div class="box2" >名称： <input type="text" name="name1"   value='+flist[i].Name+' class="borderb"/> 时间： <input type="text" name="time"   value='+ time+' class="borderb" onClick="WdatePicker()"/>'+'<a href="javascript:void(0)" class="delete" onclick="delete_this(this)">X</a></div>';
	...
	layui.use('layer', function(){
		  ...
		  $("#save").on("click",function(){
				...
				//封面
				Person["ID"]="${data.ID}";
				Person["RegionID"]='${data.RegionID}' ;        //区划ID    必需
			   ...
			   var FamilyHistoryList = [];
				...
				if($("#BirthDay").val()=="yyyy/mm/dd"){
					layer.msg("请填写出生日期",{icon: 2})
					return;
				}
				if(!($("#BirthDay").val()==0||$("#BirthDay").val()==1||$("#BirthDay").val()==2||$("#BirthDay").val()==9)){
