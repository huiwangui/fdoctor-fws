    ...
    <script>
    	...
    	function tableConfig(){
    		layui.config({
                ...
                btable.set({
                    elem: '#content',
                    url: '/FWS/hypertension/queryHypertensionFollowUp',
                    type: 'GET',
                    pageSize: 15,
                    columns: [{
                        fieldName: 'ID',
                    ...
                    btable.getSelections(function (obj) {
                    	if(obj.count == 0){
                    		layer.msg('请选择要修改的随访记录',{icon: 7,id : Math.ceil(100)});
                    	   	...
                    	   	var PersonName=obj.elem[0].context.cells[3].innerHTML;
                    		layer.open({
                         		  type: 2,
                         		  title: false,
                         		  id : Math.ceil(100),
                         		  area: ['900px', '600px'],
                         		  closeBtn: 1,
                         		  content: '/FWS/hypertension/editFollowup?ID='+obj.ids[0]+'&PersonName='+PersonName
                          	});
                    	}
                    });
                    ...
                    btable.getSelections(function (obj) {        
                    	if(obj.count == 0){
                    		...
                    		layer.open({
                         		  ...
                         		  area: ['900px', '600px'],
                         		  closeBtn: 1,
                         		  content: '/FWS/hypertension/addFollowupShow?PersonID='+PersonID
                          	});
                    	}
                    });
                });
                    ...
                    btable.getSelections(function (obj) {                  	
                    	if(obj.count == 0){
                    		...
                    		layer.open({
                         		  ...
                         		  area: ['900px', '500px'],
                         		  closeBtn: 1,
                         		  content: '/FWS/hypertension/personCurve?PersonID='+PersonID
                          	});
                    	}
                    })
                });
                    ...
                    btable.getSelections(function (obj) {                    
                    	if(obj.count == 0){
                    		...
                    		layer.open({
                         		  ...
                         		  area: ['600px', '400px'],
                         		  closeBtn: 1,
                         		  content: '/FWS/hypertension/toDelete?&PersonID='+PersonID
                          	});
                    	}
                    });
